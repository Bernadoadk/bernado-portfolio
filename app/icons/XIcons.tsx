...
export const XIcon = (props: ComponentPropsWithRef<"svg"> & {size?: number}) => {
    return (
        <svg width={props.size} height={props.size} viewBox="0 0 251 256" version="1.1" preserveAspectRatio="xMidYMid" {...props}>
            <g>
